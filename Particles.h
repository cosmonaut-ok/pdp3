...
public:
	...
	Particles(char const *p_name, flcuda p_charge, flcuda p_mass, int p_number,
...
public:
	...
	void set_simple_cell(int** cell_arr_jr,
                       ...
                       int i_new,
                       int k_new);
	void get_cell_numbers_jr_2(flcuda x1_new,
                             flcuda x3_new,
                             flcuda x1_old,
                             flcuda x3_old,
                             int **cell_arr_jr,
                             int **cell_arr_jz,
                             int* number);
	void get_cell_numbers_jr_1(flcuda x1_new,
                             flcuda x3_new,
                             flcuda x1_old,
                             flcuda x3_old,
                             int *i_return,
