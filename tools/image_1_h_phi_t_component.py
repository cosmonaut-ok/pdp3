...
class Pdp1Image(Pdp1HTViewBuilder):
    ...
    def create_view_with_1_plot(self, view, write):
        ...
        image_file_name = os.path.join(self.image_path, 'image_1_h_phi_t_' + str(self.longitude) + 'm_' + str(self.radius) + 'm.png')
...
def main():
    ...
    if os.path.isfile(args.properties_path):
        ...
        ################################################################################################
        if args.range_h_phi: image.range_h_field_phi = list(map(float, args.range_h_phi.split(':')))
