...
%             [ex ey fi] = field_2(rho, 1, 0, bc.left_value*ones(1,geometry.ngy), bc.right_value*ones(1,geometry.ngy)...
...
%             rho_beam = charge_weighting_3(P(2),p_internal_prop,geometry,bc);
            im = image([0 handles.geometry.x_size],[0 handles.geometry.y_size], ...
                        rho,'Parent',handles.axes1,'cDataMapping','scaled');
