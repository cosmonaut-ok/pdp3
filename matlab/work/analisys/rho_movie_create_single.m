...
path = 'I:\_results\ion_motion_22-42e14_Ly_20_02_04\';
path4wr = 'I:\_results\ion_motion_22-42e14_Ly_20_02_04\_movie\';
load('I:\_results\ion_motion_22-42e14_Ly_20_02_04\ion_motion_21-42_1e12_005Ly_periodic.mat', 'param');
...
f = figure;
set(f, 'Position', [50 60 800 400], 'Color', 'white');    
...
set(a1, 'xTick', [1 700 1399], 'xTickLabel', ['0.0'; '0.2'; '0.4'],...
    'yTick', [256 512], 'yTickLabel', ['0.1'; '0.2'], 'Clim', clim1,...
    'YDir', 'normal'); 


    text_title = text(0.2, 1.05, strcat('\omega_m_o_d\cdott =','  ',num2str(0/Tmod,'%2.1f')), ...
...
%         set(im1, 'CData', imfilter(rho_el_delta,filter));
    ...
    set(text_title, 'String',strcat(' \omega_0\cdott =  ','  ',num2str(t/Tmod,'%2.1f')));
...
min(min(rho_ion_delta))
max(max(rho_ion_delta))
