...
path4wr = 'd:\_results\03.06\_movie\';
% path = 'c:\movie';
var = 'rho_sp';
% name_sp = 'rho_beam_';
...
if rho_back_struct.enabled
    rho_back = load_rho_back(rho_back_struct, geometry, bc)*1.6e-19;
        ...
        Tick_position_1 = [2000 4000 6000];
        Tick_position_2 = [2000 4000 6000];
        
        Tick_label_1 = ['2000'; '4000'; '6000'];
        Tick_label_2 = ['2000'; '4000'; '6000'];
...
%         rho_ions = rho_sp;     
        ...
        im2 = image(zeros(256,2048),'Parent',a2, 'CDataMapping', 'scaled');
...
%        hold off;
    ...
    text_n_b = text(0.7, -0.8, 'n_b_e_a_m = 1\cdot10^1^1 m^-^3', 'FontSize', 14, 'Parent', a1,'Unit','normalized');
    ...
    text_axes_1 = text(1.08, 0.9,'|E|, V/m' , 'Parent', a1,'Unit','normalized','FontSize', 16);
%     text_n_el_2 = text(1.1, 0.65, '10^1^4 m^-^3', 'Parent', a1,'Unit','normalized','FontSize', 12);
    
    text_axes_21 = text(1.065, 2.15, '|E|, V/m', 'Parent', a1,'Unit','normalized','FontSize', 16);
    text_axes_22 = text(1.065, 1.95, 'averaged', 'Parent', a1,'Unit','normalized','FontSize', 16);
    
    text_axes_3 = text(1.02, 3.4, 'Maximum E', 'Parent', a1,'Unit','normalized','FontSize', 16);
...
%         set(im1, 'CData', e_abs);
     im1 = image(e_abs,'Parent',a1, 'CDataMapping', 'scaled');   
        [valy posy] = max(e_abs);
        [val posx] = max(valy);
        x = posx;
        y = posy(x);
        max_el(end+1) = val;
        time_vec(end+1) = t*w/2/pi;
        
        plot(time_vec,max_el, 'Parent', a3);
        set(a3,'xlim',time_lim,'ylim',clim3)
        

p1 = plot(x, y,'-.or', 'MarkerFaceColor','r','MarkerEdgeColor','k', 'MarkerSize',10, 'Parent', a1);
...
set(text_title, 'String', strcat('Beam-plasma interaction,  t =','  ',num2str(t/Tmod,'%2.1f'),'  T_m_o_d', ' ,moveless ions'));
